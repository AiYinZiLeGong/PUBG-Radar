...
const val vehicle2Width = 4000f
const val vehicle4Width = 8000f
const val vehicle6Width = 16000f
const val directionRadius = 16000f
const val airDropRadius = 4000f
const val itemRadius = 2000f
...
val aimLineColor = Color(1.0f, 0f, 0f, 1f)
